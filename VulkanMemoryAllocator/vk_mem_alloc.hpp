/// A patched version for clang retreived from https://github.com/malte-v/VulkanMemoryAllocator-Hpp/issues/4
/// TODO remove this file and add the repo above as a submodule when that is merged.
...
namespace VMA_HPP_NAMESPACE {
    ...
    struct AllocatorCreateInfo
    {
        AllocatorCreateInfo( AllocatorCreateFlags flags_ = AllocatorCreateFlags(),
                             ...
                             uint32_t vulkanApiVersion_ = VK_MAKE_VERSION(1, 1, 0))
        ...
        AllocatorCreateInfo & setInstance( const VULKAN_HPP_NAMESPACE::Instance instance_ )
        {
            instance = instance_;
            return *this;
        }

        AllocatorCreateInfo & setVulkanApiVersion( const uint32_t vulkanApiVersion_ )
        {
            vulkanApiVersion = vulkanApiVersion_;
            return *this;
        }
